...
int main() {
    ...
    dm.createServiceManager<HttpHostService, IHttpService>(IchorProperties{{"Address", Ichor::make_any<std::string, std::string>("127.0.0.1"s)}, {"Port", Ichor::make_any<uint16_t>(8001)}});

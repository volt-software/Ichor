...
Ichor::v1::IOUringTimer::IOUringTimer(Ichor::ScopedServiceProxy<IIOUringQueue*> queue, uint64_t timerId, ServiceIdType svcId) noexcept : _q(queue), _timerId(timerId), _requestingServiceId(svcId) {

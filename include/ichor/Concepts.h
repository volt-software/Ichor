...
namespace Ichor {
    ...
    template <class ImplT, class Interface>
    concept ImplementsTrackingHandlers = requires(ImplT impl, v1::AlwaysNull<Interface*> svc, DependencyRequestEvent const &reqEvt, DependencyUndoRequestEvent const &reqUndoEvt) {

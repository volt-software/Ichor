...
TEST_CASE("RedisTests") {
    SECTION("Set/get") {
        ...
        std::thread t([&]() {
            ...
            dm.createServiceManager<HiredisService, IRedis>(Properties{{"Address", Ichor::make_any<std::string>("127.0.0.1")}, {"Port", Ichor::make_any<uint16_t>(static_cast<uint16_t>(6379))}, {"PollIntervalMs", Ichor::make_any<uint64_t>(1ul)}, {"TimeoutMs", Ichor::make_any<uint64_t>(1'000ul)}});

...
TEST_CASE("StlTests: RealTimeMutex basics") {
    RealtimeMutex m;
    m.lock();
...
TEST_CASE("StlTests: RealtimeReadWriteMutex basics") {
...
TEST_CASE("StlTests: typeName tests") {
...
TEST_CASE("StlTests: NeverNull tests") {
...
TEST_CASE("StlTests: ReferenceCountedPointer tests") {
    {
...
TEST_CASE("StlTests: FastAtoi(u) tests") {
...
TEST_CASE("StlTests: string_view split tests") {
...
TEST_CASE("StlTests: string_view split tests2") {
    std::string_view s{"this\nis\na\nstring\n"};
    std::string_view s2{"this\r\nis\r\na\r\nstring\r\n"};
    std::string_view s3{"this\r\n\r\nis\r\n\r\na\r\n\r\nstring\r\n\r\n"};
...
TEST_CASE("StlTests: Version parse tests") {
...
TEST_CASE("StlTests: Version tests") {
    Version v1{1, 2, 3};
    Version emptyV{};
...
TEST_CASE("StlTests: Basename tests") {
...
TEST_CASE("StlTests: StaticVector tests") {
...
TEST_CASE("StlTests: SectionalPriorityQueue basics") {
    {
...
TEST_CASE("StlTests: Fast Hex String To Uint64_t") {
...
TEST_CASE("StlTests: Safe Hex String To Uint64_t") {
...
TEST_CASE("StlTests: StrongTypedef") {
    StrongTypeTest sul{};
    ++sul;
    REQUIRE(sul.value == 1);
